...
function makePinIcon(active: boolean) {
  ...
  return L.divIcon({
    ...
    html: `<div style="position:relative;width:30px;height:38px;filter:drop-shadow(0 4px 8px rgba(0,0,0,0.28));">
      <svg viewBox="0 0 34 42" width="30" height="38" xmlns="http://www.w3.org/2000/svg">
        <path d="M17 41 C17 41 32 26 32 16 A15 15 0 1 0 2 16 C2 26 17 41 17 41 Z" fill="${bg}" stroke="${ring}" stroke-width="1.5"/>
