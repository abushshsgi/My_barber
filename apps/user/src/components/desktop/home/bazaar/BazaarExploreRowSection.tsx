...
function ExploreStyleCard({ style }: { style: TrendingHairstyle }) {
  ...
  return (
    <Link
      ...
      className="group block w-[168px] shrink-0 snap-start transition-opacity hover:opacity-95 sm:w-[180px] lg:w-[200px]"
    >
    ...
    <div className="min-w-0 lg:col-span-5 lg:col-start-1">
      ...
      <div className="no-scrollbar flex gap-4 overflow-x-auto pb-1">
        {Array.from({ length: HOME_SALON_ROW_PREVIEW }).map((_, i) => (
          <div key={i} className="w-[168px] shrink-0 animate-pulse sm:w-[180px] lg:w-[200px]">
