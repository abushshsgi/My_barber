  ...
  return (
    <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-6">
      <ProfileSubpageCard className="border-foreground bg-foreground text-background lg:sticky lg:top-20">
        ...
        <p className="mt-1 text-xs font-bold text-background/60">{recipientLabel || "Sovg'a oluvchi"}</p>
      </ProfileSubpageCard>

      <div>
        <section className="mt-6 lg:mt-0">
          <h3 className="text-[10px] font-bold uppercase tracking-[0.18em] text-muted-foreground">Summani tanlang</h3>
