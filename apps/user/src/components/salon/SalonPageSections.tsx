...
import { SalonMobileServicesGrid } from "@/components/salon/SalonMobileServicesGrid";
import { SalonMobileStaffRow } from "@/components/salon/SalonMobileStaffRow";
...
export function SalonPageSections({
  ...
  return (
    <div className="space-y-0">
      ...
      {!isMobile && (salon.hours.length > 0 || salon.closedWeekdays.length > 0) ? (
