      ...
      >
        ...
        <div className="relative mt-6">
          ...
          <input
            ...
            className="h-12 w-full rounded-full bg-white/[0.06] pl-10 pr-4 text-sm text-white outline-none ring-1 ring-white/10 placeholder:text-white/30"
          />
        </div>
          ...
          <div className="mt-6 space-y-2">
            {rows.map((row) => (
              <Link
                ...
                className="flex gap-3 rounded-2xl bg-white/[0.04] p-3 ring-1 ring-white/8"
              >
                {row.image_url ? (
                ...
                <div className="min-w-0">
                  ...
                  {row.purpose_uz ? (
                    <p className="mt-1 line-clamp-2 text-[13px] text-white/55">{row.purpose_uz}</p>
                  ) : null}
                </div>
              </Link>
            ))}
