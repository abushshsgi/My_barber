...
export const DESKTOP_HEADER_HEIGHT = "5.5rem";
export const DESKTOP_HEADER_HEIGHT_CLASS = "h-[5.5rem]";
export const DESKTOP_HEADER_OFFSET_CLASS = "lg:top-[5.5rem]";
export const DESKTOP_VIEWPORT_BELOW_HEADER = "h-[calc(100dvh-5.5rem)]";
