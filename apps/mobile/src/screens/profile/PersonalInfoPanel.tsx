...
const styles = StyleSheet.create({
  ...
  hint: { marginTop: 4, fontSize: 12, lineHeight: 16 },
  edit: { fontSize: 13, fontWeight: "600", marginTop: 2 },
  infoBox: {
    marginTop: 12,
    marginBottom: 8,
    borderWidth: 1,
  ...
  sheetRow: { flexDirection: "row", gap: 10, justifyContent: "flex-end" },
  sheetBtn: { paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12 },
  sheetBtnPrimary: { minWidth: 120, alignItems: "center" },
