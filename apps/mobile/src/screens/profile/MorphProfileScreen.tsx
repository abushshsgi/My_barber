...
function makeStyles(pal: MorphPalette, fs: (n: number) => number) {
  return StyleSheet.create({
    ...
    metaPlan: { marginTop: 2, ...morphFont, fontSize: fs(12), color: pal.muted },
    usageCard: {
      backgroundColor: pal.card,
      borderRadius: 20,
      padding: 14,
    ...
    trackFill: { height: "100%", borderRadius: 3.5 },
    usageBottom: {
      marginTop: 8,
      flexDirection: "row",
      alignItems: "center",
    ...
    historyRow: { gap: 8, paddingBottom: 10 },
    thumb: { width: 96, height: 120, borderRadius: 14, overflow: "hidden" },
    thumbImg: { position: "absolute", top: 0, right: 0, bottom: 0, left: 0 },
    thumbFallback: { backgroundColor: pal.iconTile },
    thumbScrim: { position: "absolute", left: 0, right: 0, bottom: 0, height: 44 },
    thumbTitle: {
      position: "absolute",
      left: 6,
      right: 6,
    ...
    menuValue: { ...morphFont, fontSize: fs(13), color: pal.muted, marginRight: 2 },
    menuBadge: {
      minWidth: 20,
      height: 18,
      borderRadius: 9,
    ...
    menuBadgeText: { ...morphFont, fontSize: 10.5, fontWeight: "700", color: "#FFFFFF" },
    logout: {
      marginTop: 2,
      minHeight: 46,
      borderRadius: 16,
