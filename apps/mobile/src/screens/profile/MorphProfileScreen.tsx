...
function makeStyles(pal: MorphPalette, fs: (n: number) => number) {
  return StyleSheet.create({
    ...
    avatarText: { ...morphFont, fontSize: fs(19), fontWeight: "700", color: "#FFFFFF" },
    checkBadge: {
      position: "absolute",
      right: -1,
      bottom: -1,
    ...
    metaPlan: { marginTop: 4, ...morphFont, fontSize: fs(13), color: pal.muted },
    usageCard: {
      backgroundColor: pal.card,
      borderRadius: 24,
      padding: 18,
    ...
    menuTitle: { ...morphFont, fontSize: fs(15), fontWeight: "500", color: pal.fg },
