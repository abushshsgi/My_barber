...
const styles = StyleSheet.create({
  ...
  lead: { fontSize: fontSize(15), lineHeight: fontSize(21), color: colors.muted, marginBottom: verticalScale(20) },
  group: {
  ...
  q: { fontSize: fontSize(16), fontWeight: "600", color: colors.fg },
  a: { marginTop: verticalScale(6), fontSize: fontSize(14), lineHeight: fontSize(20), color: colors.muted },
  meta: { marginTop: verticalScale(6), fontSize: fontSize(12), color: colors.muted },
  empty: { padding: moderateScale(16), fontSize: fontSize(14), color: colors.muted },
  chips: { flexDirection: "row", flexWrap: "wrap", gap: moderateScale(8), padding: moderateScale(14), paddingBottom: 0 },
  chip: {
  ...
  chipText: { fontSize: fontSize(13), fontWeight: "600", color: colors.fg },
  ...
  textarea: { minHeight: verticalScale(110), marginBottom: verticalScale(4) },
  error: { marginHorizontal: scale(16), marginTop: verticalScale(8), color: "#FF3B30", fontSize: fontSize(13) },
  submit: {
  ...
  submitText: { color: "#FFF", fontSize: fontSize(16), fontWeight: "700" },
  pressed: { opacity: 0.72 },
  thread: { padding: moderateScale(16), gap: moderateScale(10), paddingBottom: verticalScale(24) },
  bubbleWrap: { alignItems: "flex-start" },
  bubble: { maxWidth: "86%", borderRadius: moderateScale(18), paddingHorizontal: scale(14), paddingVertical: verticalScale(10) },
  bubbleMine: { backgroundColor: colors.fg, borderBottomRightRadius: moderateScale(6) },
  bubbleAdmin: { backgroundColor: colors.surface, borderBottomLeftRadius: moderateScale(6) },
  bubbleMeta: { fontSize: fontSize(10), fontWeight: "600", color: colors.muted, marginBottom: verticalScale(4) },
  bubbleBody: { fontSize: fontSize(15), lineHeight: fontSize(21), color: colors.fg },
  composer: {
    flexDirection: "row",
    alignItems: "flex-end",
    gap: moderateScale(8),
  ...
  closed: { textAlign: "center", padding: moderateScale(12), color: colors.muted, fontSize: fontSize(13) },
});
