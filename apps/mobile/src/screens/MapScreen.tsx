...
const styles = StyleSheet.create({
  ...
  err: { paddingHorizontal: 16, color: "#EF4444", marginBottom: 4 },
  listPad: { paddingHorizontal: 14, gap: 10, paddingTop: 4 },
  card: {
    backgroundColor: colors.surface,
    borderRadius: 14,
    padding: 12,
  ...
  empty: { color: colors.muted, paddingHorizontal: 8, paddingTop: 12 },
});
