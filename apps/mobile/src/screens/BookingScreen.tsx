...
const styles = StyleSheet.create({
  ...
  block: { gap: 10 },
  blockTitle: { fontWeight: "800", color: colors.fg, marginBottom: 4 },
  empty: { color: colors.muted, marginTop: 16, textAlign: "center" },
  rowCard: {
    flexDirection: "row",
    alignItems: "center",
    gap: 12,
  ...
  rowMeta: { marginTop: 2, color: colors.muted },
  ...
  summaryLabel: { color: colors.muted, fontWeight: "600", fontSize: 13 },
  summaryValue: {
    flex: 1,
    textAlign: "right",
    color: colors.fg,
  ...
  summaryBold: { fontSize: 15, fontWeight: "800" },
  footer: {
    position: "absolute",
    left: 0,
    right: 0,
