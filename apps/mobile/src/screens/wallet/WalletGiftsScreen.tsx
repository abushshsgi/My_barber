...
const styles = StyleSheet.create({
  ...
  heroAmt: { marginTop: 12, color: "#FFF", fontSize: 28, fontWeight: "800" },
  heroSub: { marginTop: 6, color: "rgba(255,255,255,0.55)", fontSize: 12 },
  h2: { marginTop: 22, fontSize: 16, fontWeight: "800", color: colors.fg },
  hint: { marginTop: 4, fontSize: 13, color: colors.muted, lineHeight: 18 },
  useRow: { flexDirection: "row", gap: 8, marginTop: 12 },
  useCard: {
    flex: 1,
    borderWidth: 1,
  ...
  useTitle: { fontSize: 13, fontWeight: "800", color: colors.fg },
  useHint: { fontSize: 10, color: colors.muted },
  ...
  filterText: { fontSize: 13, fontWeight: "700", color: colors.fg },
  ...
  sendText: { fontSize: 15, fontWeight: "800", color: colors.fg },
  empty: { textAlign: "center", marginTop: 28, color: colors.muted },
  giftCard: { marginTop: 14, borderRadius: 28, overflow: "hidden" },
  giftInner: { padding: 20 },
  ...
  giftBrand: { fontSize: 14, fontWeight: "700", opacity: 0.85 },
  giftDesign: {
    marginTop: 24,
    fontSize: 11,
    fontWeight: "700",
  ...
  giftAmt: { marginTop: 6, fontSize: 30, fontWeight: "800" },
  giftMeta: { flexDirection: "row", gap: 12, marginTop: 18 },
  metaLabel: { fontSize: 9, fontWeight: "700", letterSpacing: 1, opacity: 0.55 },
  metaVal: { marginTop: 2, fontSize: 12, fontWeight: "600" },
  giftMsg: { marginTop: 12, fontSize: 12, opacity: 0.7 },
  giftFooter: {
    marginTop: 14,
    flexDirection: "row",
  ...
  giftDate: { fontSize: 12, opacity: 0.65 },
