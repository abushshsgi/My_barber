...
const styles = StyleSheet.create({
  ...
  block: { marginTop: 20 },
  blockTitle: { fontWeight: "800", color: colors.fg, marginBottom: 10 },
  ...
  serviceMeta: { marginTop: 2, color: colors.muted },
  servicePrice: { fontWeight: "800", color: colors.fg },
  staffRow: { gap: 12 },
  staffCard: { width: 88, alignItems: "center" },
  staffAvatar: {
    width: 72,
    height: 72,
    borderRadius: 36,
  ...
  staffRole: { marginTop: 2, color: colors.muted, textAlign: "center" },
