...
const styles = StyleSheet.create({
  ...
  reportTitle: { ...morphFont, fontSize: 16, fontWeight: "700", color: "#111" },
  reportFilter: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
  ...
  hubCardTitle: { ...morphFont, flex: 1, fontSize: 12, fontWeight: "600", color: "rgba(26,26,26,0.72)" },
  hubCardMetric: { ...morphFont, fontSize: 17, fontWeight: "800", color: "#111", letterSpacing: -0.3 },
  hubCardSub: { ...morphFont, fontSize: 10.5, lineHeight: 14, color: "rgba(26,26,26,0.48)", marginTop: "auto" },
  aiAssistant: {
    height: 54,
    borderRadius: 20,
