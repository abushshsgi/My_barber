...
const styles = StyleSheet.create({
  ...
  chipText: { fontSize: fontSize(13), fontWeight: "600", color: "#EBEBF5" },
  ...
  textarea: { minHeight: verticalScale(120), marginBottom: verticalScale(4) },
  error: {
  ...
  submitText: { fontSize: fontSize(16), fontWeight: "600", color: "#FFFFFF" },
  disabled: { opacity: 0.45 },
  pressed: { opacity: 0.72 },
  thread: { paddingTop: verticalScale(12), paddingBottom: verticalScale(16), gap: moderateScale(10) },
