...
const styles = StyleSheet.create({
  ...
  topTitle: { color: "#FFF", fontWeight: "800", fontSize: fontSize(16) },
  limitPill: {
    backgroundColor: "#FFF",
    borderRadius: 999,
  ...
  limitPillText: { fontWeight: "800", fontSize: fontSize(11), color: "#050505" },
  body: { paddingHorizontal: scale(16), paddingBottom: verticalScale(32), gap: moderateScale(14) },
  previewWrap: {
  ...
  compareBadgeText: { color: "#FFF", fontWeight: "700", fontSize: fontSize(11) },
  toolbar: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: moderateScale(8),
  ...
  error: { color: "#FCA5A5", fontSize: fontSize(13) },
  catRow: { gap: moderateScale(8), paddingVertical: verticalScale(2) },
  catChip: {
    paddingHorizontal: scale(14),
  ...
  catChipText: { color: "rgba(255,255,255,0.7)", fontWeight: "700", fontSize: fontSize(13) },
  catChipTextOn: { color: "#050505" },
  options: { flexDirection: "row", flexWrap: "wrap", gap: moderateScale(8) },
  opt: {
    flexDirection: "row",
    alignItems: "center",
    gap: moderateScale(8),
  ...
  swatch: { width: scale(16), height: scale(16), borderRadius: moderateScale(8) },
  swatchPlaceholder: {
    width: scale(16),
    height: scale(16),
  ...
  optText: { fontWeight: "700", fontSize: fontSize(13), color: "#FFF" },
});
