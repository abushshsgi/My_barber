...
const STATUS_MAP: Record<BarberStatus, { label: string; className: string }> = {
  ...
  in_progress: { label: "Davom etmoqda", className: "bg-foreground text-background border-foreground" },
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-4 shadow-sm">
      ...
      <div className="flex items-center gap-2 mt-1">
        {trend && (
          <span className={cn("text-xs font-medium", trend.value >= 0 ? "text-foreground" : "text-destructive")}>
