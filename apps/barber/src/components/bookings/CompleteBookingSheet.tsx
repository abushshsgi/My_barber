        ...
        return (
          ...
          >
            <button
              ...
              className={cn(
                "relative flex aspect-square w-full items-center justify-center rounded-2xl border-2 transition-colors active:scale-95",
                active
          ...
          <>
            ...
            <motion.div
              ...
              className={cn(
                ...
                phase === "done" ? "max-h-[40dvh] max-w-lg" : "max-h-[min(92dvh,720px)] max-w-lg lg:max-w-2xl",
              )}
            >
              ...
              {phase === "done" ? (
                ...
                <div className="px-5 pb-[max(env(safe-area-inset-bottom),1.25rem)] pt-4">
                  ...
                  <p className="mt-4 text-sm text-muted-foreground">
                    Mijoz ifodalarini belgilang (ixtiyoriy):
                  </p>

                  <div className="mt-4 rounded-2xl border border-border bg-muted/20 px-3 py-4">
                    <ImpressionIconGrid selected={selected} onToggle={toggleKind} />
                  </div>
