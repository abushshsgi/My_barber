...
/** Partner signup: agent invite QR (URL yoki sof kod). */
export function AgentQrScanner({
  ...
  useEffect(() => {
    ...
    if (!Detector) {
      setError("Bu qurilmada avtomatik skaner yo‘q. Kodni qo‘lda kiriting.");
      return;
    }
  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col bg-black/95">
      ...
      <div className="p-5 text-center text-sm text-white/80">
        {error ? error : "Agent QR kodini ramka ichiga joylashtiring"}
      </div>
    </div>
  );
}
