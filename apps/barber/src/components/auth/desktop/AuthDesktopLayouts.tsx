...
export function AuthDesktopLayout({ tab, flow, marketingVariant, ...props }: AuthDesktopLayoutProps) {
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      <AuthMarketingPanel tab={tab} flow={flow} variant={marketingVariant} />
      <FormPanel tab={tab} flow={flow} marketingVariant={marketingVariant} {...props} />
    </div>
  );
}
