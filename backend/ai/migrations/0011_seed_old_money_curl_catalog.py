"""Eski 12 uslubni arxivlash — Old Money orqa jingalak (5 ta) katalogiga o'tish."""

from django.db import migrations


def seed_old_money_catalog(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("ai", "0010_morphailookshare"),
    ]

    operations = [
        migrations.RunPython(seed_old_money_catalog, migrations.RunPython.noop),
    ]
