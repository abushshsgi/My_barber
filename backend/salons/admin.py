...
class SalonAdmin(admin.ModelAdmin):
    list_display = ("name", "business_kind", "owner_barber", "owner", "premium", "is_published", "created_at")
    list_filter = ("business_kind", "premium", "is_published", "created_at", "updated_at")
