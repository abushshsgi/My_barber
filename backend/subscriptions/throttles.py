...
class SubscriptionCheckoutThrottle(FriendlyThrottleMixin, UserRateThrottle):
    scope = "subscription_checkout"
    throttle_detail = "Obuna so'rovlari limiti. Biroz kutib qayta urinib ko'ring."


class SubscriptionConfirmThrottle(FriendlyThrottleMixin, UserRateThrottle):
    scope = "subscription_confirm"
    throttle_detail = "To'lov tasdiqlash limiti. Biroz kutib qayta urinib ko'ring."


class SubscriptionIPThrottle(FriendlyThrottleMixin, SimpleRateThrottle):
