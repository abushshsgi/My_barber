...
from ai.admin_views import (
    ...
    AdminMorphAiChatThreadDetailView,
    AdminMorphAiChatView,
...
from ai.product_barcode_views import (
    AdminProductAiCoverView,
    AdminProductAiFillView,
...
from ai.care_views import (
    ...
    CareProductListView,
    CareShelfDetailView,
    CareShelfEstimateView,
    CareShelfListCreateView,
    CareSosFixView,
...
from ai.views import (
    ...
    AiMorphChatView,
    AiMorphChatVoiceSpeakView,
    AiMorphChatVoiceTranscribeView,
    AiMorphChatVoiceVoicesView,
    AiStyleAnalyzeView,
...
api_routes = [
    ...
    path("admin/morph-ai/chat/", AdminMorphAiChatView.as_view()),
    path("admin/morph-ai/chat/threads/<int:thread_id>/", AdminMorphAiChatThreadDetailView.as_view()),
    ...
    path("ai/style-tryon-views/", AiStyleTryOnViewsView.as_view()),
    ...
    path("ai/chat/voice/transcribe/", AiMorphChatVoiceTranscribeView.as_view()),
    path("ai/chat/voice/speak/", AiMorphChatVoiceSpeakView.as_view()),
    path("ai/chat/threads/", MorphAiChatThreadListView.as_view()),
    path("ai/chat/threads/<str:client_id>/", MorphAiChatThreadDetailView.as_view()),
    path("ai/chat/limits/", MorphAiChatLimitsView.as_view()),
    path("ai/privacy/", MorphAiPrivacyView.as_view()),
    path("ai/privacy/data/", MorphAiPrivacyDataView.as_view()),
