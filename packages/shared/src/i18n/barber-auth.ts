...
const uz: BarberAuthStrings = {
  ...
  reviewPathMybarber: "MyBarber salon — keyin alohida sozlash sahifasi",
...
const ru: BarberAuthStrings = {
  ...
  reviewPathMybarber: "Салон MyBarber — далее отдельная страница настройки",
...
const en: BarberAuthStrings = {
  ...
  reviewPathMybarber: "MyBarber salon — next: dedicated setup page",
